...
public class AdapterDonHoanThanhUsse extends RecyclerView.Adapter<AdapterDonHoanThanhUsse.ViewHolder> {

    Context context;
    List<DonDatUserDTO> list;

    public AdapterDonHoanThanhUsse(Context context, List<DonDatUserDTO> list) {
...
//                ((Activity)context).startActivity(new Intent(((Activity)context), ChiTietDonDatUserActivity.class));
                ...
                Intent intent = new Intent(((Activity) context), ChiTietDonDatActiviTyUSER.class);
