...
import fpl.poly.nhom9.duan1ht.Fragment.FragmentDonDatHomeAdmin;
import fpl.poly.nhom9.duan1ht.Fragment.FragmentTaiKhoanAdmin;
import fpl.poly.nhom9.duan1ht.Fragment.FragmentTaiKhoanUSER;
import fpl.poly.nhom9.duan1ht.Fragment.FragmentThongKeAdmin;
import fpl.poly.nhom9.duan1ht.Fragment.FragmentTrangChuAdmin;
import fpl.poly.nhom9.duan1ht.Fragment.FragmentTrangChuUSER;
import fpl.poly.nhom9.duan1ht.Fragment.FragmetDonDatHomeUser;
import fpl.poly.nhom9.duan1ht.Fragment.FramentGioHangUse;
            ...
            layoutDonDatAdmin.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (index != 3) {
                        ...
                        manager.beginTransaction().replace(R.id.fragContainerView, new FragmentDonDatHomeAdmin()).commit();
            ...
            layoutTaiKhoanAdmin.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (index != 4) {
                        ...
                        manager.beginTransaction().replace(R.id.fragContainerView, new FragmentTaiKhoanAdmin()).commit();
...
//
//                        layoutTrangChuAdmin.setBackgroundColor(ContextCompat.getColor(mcontext,android.R.color.transparent));
//                        layoutThongKeAdmin.setBackgroundColor(ContextCompat.getColor(mcontext,android.R.color.transparent));
//                        layoutDonDatAdmin.setBackgroundColor(ContextCompat.getColor(mcontext,android.R.color.transparent));
            ...
            manager.beginTransaction().replace(R.id.fragContainerView, new FragmentTrangChuUSER()).commit();
...
//            Gắn fragment GioHang
                        ...
                        manager.beginTransaction().replace(R.id.fragContainerView, new FramentGioHangUse()).commit();
            ...
            layoutDonDatUser.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (index != 3) {
                        ...
                        manager.beginTransaction().replace(R.id.fragContainerView, new FragmetDonDatHomeUser()).commit();
            ...
            layoutTaiKhoanUser.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (index != 4) {
                        ...
                        manager.beginTransaction().replace(R.id.fragContainerView, new FragmentTaiKhoanUSER()).commit();
