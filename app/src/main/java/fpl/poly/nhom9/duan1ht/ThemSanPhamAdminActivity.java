...
public class ThemSanPhamAdminActivity extends AppCompatActivity {
        ...
        btnThemsp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(tensp.equals("") || String.valueOf(giasp).equals("")){
                    Toast.makeText(ThemSanPhamAdminActivity.this, "Nhập đầy đủ thông tin", Toast.LENGTH_SHORT).show();
                }else if(!isImgaSelected){
                    Toast.makeText(ThemSanPhamAdminActivity.this, "Vui lòng chọn ảnh", Toast.LENGTH_SHORT).show();

                }else {
                    boolean check = trangChuAdminDAO.ThemSanPham(tensp,giasp,base64,mota,tenloai,nhacungcap);

                    if(check){
                        Toast.makeText(ThemSanPhamAdminActivity.this, "Thêm thành công", Toast.LENGTH_SHORT).show();
                        onBackPressed();

                    }else {
                        Toast.makeText(ThemSanPhamAdminActivity.this, "Thêm thất bại", Toast.LENGTH_SHORT).show();
                    }
