...
import fpl.poly.nhom9.duan1ht.Adapter.AdapterGioHang;
...
public class FramentGioHangUse extends Fragment {
    ...
    public DonDatUseDAO donDatUserDAO;
            ...
            for (int j = 0; j < listSanPham.size(); j++) {
                ...
                if (listSanPham.get(j).getTenSanPhamUser().equals(AdapterGioHang.list.get(i).getTenSanPham())) {
                    ...
                    hoaDon += "- " + listSanPham.get(j).getTenSanPhamUser()
                            + ", Số lượng: " + AdapterGioHang.list.get(i).getSoLuongSanPham() + "SP" +
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_gio_hang_user, container, false);
    }
}
