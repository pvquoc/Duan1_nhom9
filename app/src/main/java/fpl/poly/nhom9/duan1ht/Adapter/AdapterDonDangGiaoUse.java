...
public class AdapterDonDangGiaoUse extends RecyclerView.Adapter<AdapterDonDangGiaoUse.ViewHolder> {
    Context context;
    List<DonDatUserDTO> list;

    public AdapterDonDangGiaoUse(Context context, List<DonDatUserDTO> list) {
