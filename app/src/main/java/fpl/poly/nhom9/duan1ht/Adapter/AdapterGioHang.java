...
import static fpl.poly.nhom9.duan1ht.Fragment.FramentGioHangUse.tvTongTienGioHang;
...
//        viewBinderHelper.bind(holder.layoutSwipeRevealLayout, list.get(position).getId() + "");
        ...
        holder.tvGiaMacDinh.setText(decimalFormat.format(list.get(position).getGiaSanPham()) + " VND");
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        LinearLayout layoutSwipeRevealLayout;
